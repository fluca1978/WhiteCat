...
public class MethodForwarderGeneratorFactory {
    ...
    public static MethodForwarderGenerator getMethodForwarderGenerator() throws WCForwarderMethodException{
	try{
	    ...
	    return (MethodForwarderGenerator) Class.forName(className).newInstance();
